...
export default function NotificationsCard() {
  ...
  return (
    ...
    >
      ...
      <div style={subStyle}>
        <SettingRow label="Processamento do clipboard">
          <Toggle
        ...
        <SettingRow label="Resposta do clipboard">
          <Toggle
        ...
        <SettingRow label="Resposta de chat (sem foco)">
          <Toggle
        ...
        <SettingRow label="Clipboard vazio">
          <Toggle
